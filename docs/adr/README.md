...
| [0006](0006-user-operation-lock.md) | Merge and SCIM replacement share one user-operation lock boundary | Accepted |
...
Each implementation PR should reconcile PRD/TRD/Architecture/UML/ERD/Threat/Test/Operability/Traceability and the relevant doctoring/runbook when those contracts move.